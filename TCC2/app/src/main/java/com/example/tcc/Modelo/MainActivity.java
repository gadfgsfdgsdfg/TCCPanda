...
import com.example.tcc.Activity.TelaPreferencias;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPreferenciass = findViewById(R.id.btnPreferencias);


        btnPreferenciass.setOnClickListener(event->{
                startActivity(new Intent(MainActivity.this, TelaPreferencias.class));
        });
